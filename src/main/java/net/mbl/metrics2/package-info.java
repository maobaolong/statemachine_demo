 ...
 * and publication.
 * </p><p>The framework provides a variety of ways to implement metrics
 * instrumentation easily via the simple
 * {@link net.mbl.metrics2.MetricsSource} interface
 ...
 * {@link net.mbl.metrics2.MetricsSink} interface. Producers
 ...
 * <h3>Sub-packages</h3>
 * <dl>
 * <dt><code>net.mbl.metrics2.annotation</code></dt>
 * <dd>Public annotation interfaces for simpler metrics instrumentation.
 * </dd>
 * <dt><code>net.mbl.metrics2.impl</code></dt>
 ...
 * </dd>
 * <dt> <code>net.mbl.metrics2.lib</code></dt>
 * <dd>Convenience classes for implementing metrics sources, including the
 * Mutable[{@link net.mbl.metrics2.lib.MutableGauge Gauge}*|
 * {@link net.mbl.metrics2.lib.MutableCounter Counter}*|
 * {@link net.mbl.metrics2.lib.MutableStat Stat}] and
 * {@link net.mbl.metrics2.lib.MetricsRegistry}.
 * </dd>
 * <dt> <code>net.mbl.metrics2.filter</code></dt>
 * <dd>Builtin metrics filter implementations include the
 * {@link net.mbl.metrics2.filter.GlobFilter} and
 * {@link net.mbl.metrics2.filter.RegexFilter}.
 * </dd>
 * <dt><code>net.mbl.metrics2.source</code></dt>
 * <dd>Builtin metrics source implementations including the
 * {@link net.mbl.metrics2.source.JvmMetrics}.
 * </dd>
 * <dt> <code>net.mbl.metrics2.sink</code></dt>
 * <dd>Builtin metrics sink implementations including the
 * {@link net.mbl.metrics2.sink.FileSink},
 * {@link net.mbl.metrics2.sink.GraphiteSink}, and
 * {@link net.mbl.metrics2.sink.StatsDSink}.
 * </dd>
 * <dt> <code>net.mbl.metrics2.util</code></dt>
 * <dd>General utilities for implementing metrics sinks etc., including the
 * {@link net.mbl.metrics2.util.MetricsCache}.
 * </dd>
 * </dl><h2><a name="gettingstarted">Getting started</a></h2>
 ...
 * class MyStat {&#064;Metric("My metric description")
 * public int getMyMetric() {
 * return 42;
 * }
 * }</pre></td><td>
 * <pre>
 * class MyStat implements MetricsSource {&#064;Override
 ...
 * the usage of some cache in your application.</dd><dt><em>&#064;Metric</em></dt>
 * <dd>The {@link net.mbl.metrics2.annotation.Metric} annotation
 ...
 * </dd>
 * </dl>
 * <p>Note, the {@link net.mbl.metrics2.MetricsSource} interface is
 ...
 * for more examples.
 * </p><h2><a name="filtering">Metrics Filtering</a></h2>
 ...
 * <pre>
 * test.sink.file0.class=net.mbl.metrics2.sink.FileSink
 ...
 * </p>
 * <pre>
 * .source.filter.class=net.mbl.metrics2.filter.GlobFilter
 ...
 * the filtering efficiency.</p><h2><a name="instrumentation">Metrics instrumentation strategy</a></h2>In previous examples, we showed a minimal example to use the
 ...
 * class MyMetrics extends MyInstrumentation {&#064;Metric("My gauge description") MutableGaugeInt gauge0;
 * &#064;Metric("My counter description") MutableCounterLong counter0;
 * &#064;Metric("My rate description") MutableRate rate0;&#064;Override public void setGauge0(int value) { gauge0.set(value); }
 * &#064;Override public void incrCounter0() { counter0.incr(); }
 * &#064;Override public void addRate0(long elapsed) { rate0.add(elapsed); }
 * }
 * </pre>Note, in this example we introduced the following:
 * <dl>
 ...
 * </dd>
 * </dl><h2><a name="migration">Migration from previous system</a></h2>
 ...
 * </td>
 * <td><pre>
 * myprefix.sink.*.class=net.mbl.metrics2.sink.FileSink
