...
import net.mbl.metrics2.util.Quantile;
import net.mbl.metrics2.util.QuantileEstimator;
import net.mbl.metrics2.util.SampleQuantiles;
...
import static net.mbl.metrics2.lib.Interns.info;
