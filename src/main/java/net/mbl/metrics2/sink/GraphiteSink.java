...
public class GraphiteSink implements MetricsSink, Closeable {
    ...
    public void init(SubsetConfiguration conf) {
        ...
        final int serverPort = Integer.parseInt(conf.getString(SERVER_PORT_KEY));// Get Graphite metrics graph prefix.
    ...
    public void putMetrics(MetricsRecord record) {
        ...
        StringBuilder metricsPathPrefix = new StringBuilder();// Configure the hierarchical place to display the graph.
        ...
        long timestamp = record.timestamp() / 1000L;// Collect datapoints.
