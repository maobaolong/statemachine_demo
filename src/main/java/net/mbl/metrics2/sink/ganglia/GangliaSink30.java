...
import net.mbl.metrics2.impl.MsInfo;
import net.mbl.metrics2.util.MetricsCache;
import net.mbl.metrics2.util.MetricsCache.Record;
...
public class GangliaSink30 extends AbstractGangliaSink {
     ...
     * net.mbl.metrics.ganglia.GangliaContext30 with minimal changes in
