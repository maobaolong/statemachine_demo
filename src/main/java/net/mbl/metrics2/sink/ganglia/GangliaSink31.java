...
public class GangliaSink31 extends GangliaSink30 {
     ...
     * net.mbl.metrics.ganglia.GangliaContext31 with minimal changes in
    ...
    protected void emitMetric(String groupName, String name, String type,
        ...
        // the gmetric utility with strace.// First we send out a metadata message
        ...
        xdr_string(groupName);      /*Group value*/// send the metric to Ganglia hosts
        emitToGangliaHosts();// Now we send out a message with the actual value.
        ...
        xdr_string(value);    // metric value// send the metric to Ganglia hosts
        emitToGangliaHosts();
    }
}
