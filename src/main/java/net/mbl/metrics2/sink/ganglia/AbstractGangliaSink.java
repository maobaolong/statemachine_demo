...
package net.mbl.metrics2.sink.ganglia;

import net.mbl.metrics2.MetricsSink;
import net.mbl.metrics2.util.Servers;
import net.mbl.net.DNS;
 ...
 * has been derived from net.mbl.metrics.ganglia.GangliaContext.
...
public abstract class AbstractGangliaSink implements MetricsSink {
    ...
    public void init(SubsetConfiguration conf) {
        ...
        this.conf = conf;// Take the hostname from the DNS class.
        ...
        multicastTtl = conf.getInt(MULTICAST_TTL_PROPERTY, DEFAULT_MULTICAST_TTL);// extract the Ganglia conf per metrics
     ...
     * (non-Javadoc)
     *
     * @see net.mbl.metrics2.MetricsSink#flush()
     */
     ...
     *
     * @see
     * net.mbl.metrics2.MetricsPlugin#init(org.apache.commons.configuration
     * .SubsetConfiguration)
     */
